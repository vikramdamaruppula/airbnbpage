...
const BottomSection = () => (
  <div className="bottom-main-container">
    ...
    <div className="container-bottom-all">
      ...
      <div className="card-container-bottom third-bottom">
      ...
      <div className="card-container-bottom fourth-bottom">
        <div className="image-part ">
          <div className="icon">
            <BsHeartFill />
          </div>
      ...
      <div className="card-container-bottom fifth-bottom">
        <div className="image-part ">
          <div className="icon">
            <BsHeartFill />
          </div>
      ...
      <div className="card-container-bottom sixth-bottom">
        <div className="image-part ">
          <div className="icon">
            <BsHeartFill />
          </div>
